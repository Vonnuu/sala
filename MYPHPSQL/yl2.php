...
<head>
    ...
    <body>
        ...
        $start = 0;
        while (true) {
            $sql = "SELECT * FROM tooted LIMIT $start, 10";
        ...
        <?php
        $sql = "SELECT artist, album FROM tooted ORDER BY artist ASC LIMIT 10";
        $result = $yhendus->query($sql);
        ...
        <?php
        $sql = "SELECT artist, album FROM tooted WHERE aasta >= 2010";
        $result = $yhendus->query($sql);
        ...
        <?php
        $loe = "SELECT COUNT(DISTINCT album) AS albumeid FROM tooted";
        $keskmine = "SELECT AVG(hind) AS keskmine FROM tooted";
        $kokku = "SELECT SUM(hind) AS koguvaartus FROM tooted";
        ...
        <h1>Vanim album</h1>
        <?php
        $sql = "SELECT album FROM tooted ORDER BY aasta ASC LIMIT 1";
        $result = $yhendus->query($sql);
        ...
        <?php
        $kesk = "SELECT AVG(hind) AS kesk FROM tooted";
        $sql = "SELECT artist, album FROM tooted WHERE hind > ($kesk)";
        ...
        if(!empty($_GET['s'])) {
            ...
            $sql = "SELECT artist, album FROM tooted WHERE artist LIKE '%$sisestus%' OR album LIKE '%$sisestus%'";
            $result = $yhendus->query($sql);
